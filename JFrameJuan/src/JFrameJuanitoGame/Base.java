...
public class Base {
    ...
    public boolean equals(Object objObjeto) {
        ...
        if (objObjeto instanceof Base) {
            // se regresa la comparaciÃ³n entre este objeto que invoca y el
     ...
     * intersecta
     * 
     * Metodo para saber si un objeto colisiona con otro
     * 
      * @return un valor <code>boleano</code> que si los 2 objetos intersectaron
     * 
     */
    public boolean intersecta(Object objBase) {
    //valido si el objeto es Planeta
    if (objBase instanceof Base) {
        //creo los rectangulso de ambos
    ...
    // si no entro entoces no es un Planeta
    return false;
    }
}